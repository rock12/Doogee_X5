...
BUILD_PRELOADER = yes
BUILD_UBOOT = no
CUSTOM_BUILD_VERNO =R08
MTK_BUILD_VERNO = DOOGEE-X5-Android6.0-20160726
...
#CREATE_PROJECT_INFO=2015121810826
####################### HCT Drv Config ----------  begin ########################
#camera and lens
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
CUSTOM_HAL_IMGSENSOR = s5k5e2ya_mipi_raw s5k4e2gx_mipi_raw  hi551_mipi_raw ov9760_mipi_raw gc2355_mipi_raw
CUSTOM_HAL_LENS =  dw9714af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = dw9714af
CUSTOM_HAL_MAIN_IMGSENSOR = s5k5e2ya_mipi_raw s5k4e2gx_mipi_raw 
...
CUSTOM_HAL_SUB_IMGSENSOR = hi551_mipi_raw ov9760_mipi_raw gc2355_mipi_raw
CUSTOM_HAL_SUB_LENS = dummy_lens
CUSTOM_KERNEL_FLASHLIGHT = constant_flashlight
CUSTOM_KERNEL_IMGSENSOR = s5k5e2ya_mipi_raw s5k4e2gx_mipi_raw  hi551_mipi_raw ov9760_mipi_raw gc2355_mipi_raw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k5e2ya_mipi_raw s5k4e2gx_mipi_raw 
CUSTOM_KERNEL_MAIN_LENS = dw9714af
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_SUB_BACKUP_LENS = 
CUSTOM_KERNEL_SUB_IMGSENSOR = hi551_mipi_raw ov9760_mipi_raw gc2355_mipi_raw
...
#TP
CUSTOM_KERNEL_TOUCHPANEL = GT9XX_V24 ft_allinone
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
#modem
CUSTOM_MODEM = g931_hct6580_we_c_m_hspa_gsm4p_fdd1_2_5
#lcm
LCM_FAKE_HEIGHT = 0
LCM_FAKE_WIDTH = 0
LCM_HEIGHT = 1280
...
CUSTOM_KERNEL_SSW =
# HCT_DEVICE_INFO_SUPPORT = yes
####################### HCT Drv Config --------------end ########################
HCT_BUILD_PRODUCT_NAME=g931bm-dg-a37-wg-hd-64g8g-60
HCT_PRODUCT_TIMEZONE = Europe/London
HCT_LOCALIZATION_OVERLAY = zh-rCN

HCT_DAOGE_APK_SYSTEM = yes

HCT_PRODUCT_MODEL= X5
HCT_PRODUCT_BRAND= DOOGEE
HCT_PRODUCT_MANUFACTURER = DOOGEE
HCT_PRODUCT_NAME = DOOGEE
...
HCT_PHONE_NUMBER_GEODESCRIPTION = yes
HCT_NO_BROWSER_NAVIGATION = yes
HCT_REMOVE_IP_PREFIX_SUPPORT = yes

HCT_BOOTANIM = yes

GANGYUN_CAMERA_BEAUTYSNAP = yes
...
HCT_FEATURE02_SUPPORT = yes

HCT_QR_CODE_SCAN = yes

HCT_LAUNCHER3 = yes
THEME_RES_NORMAL = yes
HCT_SUPPORT_DOUBLE_VOLUMEKEY_TO_CAPTURE=yes
HCT_EXTRA_RINGTONE_SHOW_MORE_RINGTONES =yes
HCT_MULTI_FINGER_GESTURE_SUPPORT = yes

#HCT_MIFEI_CALLERID_SEARCH = yes

HCT_GOOGLE_GMS_R4=yes
HCT_PACKAGES_SUBSTITUTE = SetupWizard:- MtkQuickSearchBox:- AndroidPay:- Bugle:- GoogleCamera:- GoogleHome:- GooglePinyinIME:- GoogleHindiIME:- JapaneseIME:- KoreanIME:- LatinImeGoogle:- DeskClockGoogle:- CalendarGoogle:- SetupWizard:- Chrome:- Photos:- Music2:- EditorsSheets:- EditorsDocs:- PlusOne:- Hangouts:- Keep:- Books:- Newsstand:- PlayGames:- NewsWeather:- YouTube:- Drive:- Videos:-  EditorsSlides:- scan_barcode_dg:- blue_touchpal:- QuickSearchBox:-
